            ...
            <div class="modal-body">
                ...
                <form id="gradForm">
                    ...
                    <div class="form-group">
                        <label for="NombreGrado" class="form-label">NombreGrado</label>
                        <input type="text" id="NombreGrado" name="NombreGrado" class="form-control" required>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="FKIdNivel" class="form-label">Nivel</label>
                        <input type="text" id="FKIdNivel" name="FKIdNivel" class="form-control" required>
                    </div>
